...
class ApproximateQAgent(PacmanQAgent):
    ...
    def __init__(self, extractor='IdentityExtractor', **args):
        ...
        self.features = self.featExtractor.getFeatures

    def getWeights(self):
        return self.weights

    def featureReducer(self, cumulative, value):
        feature, featureVal = value
        return self.weights[feature] * featureVal
    ...
    def getQValue(self, state, action):
        ...
        qValue = sum([self.weights[feature] * featureVal for (feature,
                     featureVal) in self.features(state, action).items()])
